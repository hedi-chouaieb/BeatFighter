...
#pragma warning restore IDE1006
        ...
        protected static (bool, RotationAngle) GetRotationMirroring(ImageSource imageSource, bool expectedToBeMirrored = false)
        {
            return (expectedToBeMirrored ^ imageSource.isHorizontallyFlipped ^ !imageSource.isFrontFacing, imageSource.rotation.Reverse());
        }
